...
#
# Version 8.27: 2021-07-22 ready-for.sh
#   - Rename LFC210 to LFC110
# 
#===============================================================================
VERSION=8.27
...
FALLBACK=(
    ...
    [CentOS.Stream-8]="RHEL-8 CentOS-8 CentOS"
    [Debian]="Ubuntu"
    [Debian-9]="Ubuntu-18.04 Debian"
    [Debian-10]="Debian-9 Ubuntu-20.04 Debian"
    [Debian-11]="Debian-10 Ubuntu-20.04 Debian"
    [Debian-999]="Debian-11 Ubuntu-20.04 Debian"
    [Fedora]="RHEL CentOS"
    [Fedora-33]="Fedora"
    ...
    [SUSE]="openSUSE"
    [Ubuntu]="Debian"
    [Ubuntu-18.04]="Debian-9 Ubuntu"
    [Ubuntu-20.04]="Debian-10 Ubuntu-18.04 Ubuntu"
    [Ubuntu-20.10]="Ubuntu-20.04 Ubuntu Debian-10"
    [Ubuntu-21.04]="Ubuntu-20.10 Ubuntu-20.04 Ubuntu Debian-11"
...
DISK=5
#DISTROS=
DISTROS[EMBEDDED]="CentOS-8+ Debian-10+ Fedora-33+ LinuxMint-20+ openSUSE-15+ Ubuntu-20.04+LTS+"
DISTROS[LFD]="CentOS-8+ Debian-10+ Fedora-33+ LinuxMint-19+ openSUSE-15+ RHEL-8+ Ubuntu-18.04+LTS+ SLES-15+"
DISTROS[LFS]="CentOS-7+ Debian-9+ Fedora-33+ LinuxMint-19+ openSUSE-15+ RHEL-7+ Ubuntu-18.04+LTS+ SLES-15+"
DISTRO_ARCH=x86_64
DISTRO_BL="CentOS-6- Debian-8- Fedora-32- LinuxMint-18.3- openSUSE-42.3- OracleLinux RHEL-6- SLES-12.2- Ubuntu-19.10-"
DISTRO_BL[EMBEDDED]="CentOS-7- Debian-9- 5 Fedora-32- LinuxMint-18.3- openSUSE-42.3- OracleLinux RHEL SLES Ubuntu-18.04 Ubuntu-19.10-"
...
# Embedded packages
#===============================================================================
PACKAGES[@embedded]="bc gperf lzop ninja-build screen"
...
#-------------------------------------------------------------------------------
PACKAGES[openSUSE_@embedded]="dtc nfs-kernel-server -ninja-build ninja"
RECOMMENDS[openSUSE_@embedded]="u-boot-tools"
SUGGESTS[openSUSE_@embedded]="cutecom"
#-------------------------------------------------------------------------------
PACKAGES[Ubuntu_@embedded]="dnsmasq-base dosfstools eject mtd-utils
...
#-------------------------------------------------------------------------------
PACKAGES[LFD435]="[LFD420] @embedded @qemuarm"
...
#-------------------------------------------------------------------------------
PACKAGES[LFD450]="@common @embedded @kernel @qemuarm @trace help2man rsync"
PACKAGES[Ubuntu_LFD450]="libglib2.0-dev libpixman-1-dev libpython3-dev libtool meson squashfs-tools"
RECOMMENDS[Ubuntu_LFD450]="gcc-arm-linux-gnueabihf libc6-dev-armhf-cross"
PACKAGES[Ubuntu-18.04_LFD450]="libpython-dev"
PACKAGES[Ubuntu-20.04_LFD450]="-"
PACKAGES[LinuxMint-20.1_LFD450]="libglib2.0-dev libpixman-1-dev"
PACKAGES[RHEL_LFD450]="python-devel"
PACKAGES[RHEL-8_LFD450]="-python-devel SDL2-devel"
PACKAGES[Fedora_LFD450]="python3-devel"
...
PACKAGES[Ubuntu-20.10_LFD460]="[Ubuntu-20.04_LFD460] -python-sqlite"
...
PACKAGES[openSUSE_LFD460]="libarchive-devel libnfs8 libSDL-devel python python-curses
	python-xml which"
...
setup_meta() {
    ...
    local ATTRS="ARCH BOGOMIPS CPUFLAGS CPUS PREFER_CPUS RAM DISK BOOT CONFIGS \
            ...
            SYMLINKS VERSIONS EXTRAS VMS INPERSON VIRTUAL SELFPACED MOOC \
